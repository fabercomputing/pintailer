...
@Component({
  selector: 'app-testcase-definition-detail-dialog',
  templateUrl: './testcase-definition-detail-dialog.component.html',
  styleUrls: ['./testcase-definition-detail-dialog.component.css'],
  animations: [
    fadeInOut, EnterLeave
  ]
})
export class TestcaseDefinitionDetailDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TestcaseDefinitionDetailDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any) {

    this.description = "Edit Test Case Definition";
