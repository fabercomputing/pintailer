...
export class SettingsComponent implements OnInit {
  ...
  currentOpenSettings = "setDefaultOrgSection"
  screenHeight = "0";
  ...
  assignUserToProject() {
    this.settingsService.assignUserToProject(this.organization, this.projectList.value, this.userList.value).subscribe(userService => {
      ...
      this.commonService.openNotificationBar(this.userList.value + " need to Re-Login again to see the changes.", "notification_important", "normal");
    });
  }
